...
def load_data():
    try:
        transactions_df = pd.read_csv('C:/Users/Bharath/Desktop/Demand/Transactional_data_retail_02.csv')
        product_info_df = pd.read_csv('C:/Users/Bharath/Desktop/Demand/ProductInfo.csv')
        customer_df = pd.read_csv('C:/Users/Bharath/Desktop/Demand/CustomerDemographics.csv')
